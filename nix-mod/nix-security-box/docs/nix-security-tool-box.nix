...
# https://github.com/fabaff/nix-security-box/tree/main
{ pkgs, lib, config, ... }:

with lib;
let cfg = config.modules.nix-security-tool-box;

in {
    options.modules.nix-security-tool-box = { enable = mkEnableOption "nix-security-tool-box"; };
